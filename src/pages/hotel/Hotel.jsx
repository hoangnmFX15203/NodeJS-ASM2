...
const Hotel = () => {
    ...
    function dayDiffrences(date1, date2) {
        const timeDiffrences = Math.abs(date2.getTime() - date1.getTime());
        const diffDays = Math.ceil(timeDiffrences / MILLISECONDS_IN_DAY);
        return diffDays;
    }
    const days = dayDiffrences(dates[0].endDate, dates[0].startDate);
